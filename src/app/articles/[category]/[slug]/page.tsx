...
export const getArticleById = cache(async (category: string, slug: string) => {
                            ...
                            components={{
                                ...
                                p: ({ node, children, ...props }) => {
                                    ...
                                    if (node?.children[0]?.type === 'element' && node.children[0].tagName === 'img') {
                                        // Return the children directly to avoid wrapping image in a paragraph
                                        return <>{children}</>;
                                    }
                                    return (
                                ...
                                img: ({ node, ...props }) => (
                                    // This will now be rendered at the root level, not inside a paragrap
